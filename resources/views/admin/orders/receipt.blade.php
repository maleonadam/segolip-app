...
<div class="recentOrders">
    ...
    @endif
    <div class="cardHeader"><h4><strong>Upload Receipt</strong></h4></div>
    <div class="card">
        <div class="card-body"> 
            <form class="form-horizontal" action="{{ route('all-orders.upload-receipt', $order->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="form-group pb-2">
                    ...
                    <input type="file" class="form-control-file pl-0" name="receipt">
                </div>
